...
int main(int argc, char** argv){
    if (argc == 1) {
        cout << " Invalid input. Please check command line input." << endl;
        cout << "   To try again, type \"./dna.out EXAMPLE.txt\"" << endl;
    }
